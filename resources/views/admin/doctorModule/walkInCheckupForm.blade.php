                    ...
                    <div class="step">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                                ...
                                <div class="card col mb-4 px-0">
                                    ...
                                    <div class="card-body">
                                        <div class="">
                                            ...
                                            <form method="POST" action="{{ route('walkincheckups.store', ['user_id' => $user->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                <!-- Assessed By (with required validation) -->
                                                <div class="form-group">
                                                    <label for="assessedBy">Assessed By <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="assessedBy" placeholder="Enter name" name="name" value="{{ $loggedInDoctor->name }} {{ $loggedInDoctor->last_name  }}" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="prescription" name="prescription"></input>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control bg-white text-dark" id="assessmentComplaint" name="complaint" rows="3"></textarea>
                                                    <div class="invalid-feedback">
                                                        Please provide details of the patient's Disposition.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-sm">
                                                            <label for="checkup_time" class="form-label">Time <span class="text-danger">*</span></label>
                                                            <select name="time" id="checkup-time" class="form-control" required>
                                                                <!-- Initial placeholder option -->
                                                                <option value="">Choose Time </option>
                                                                @if ($staffSchedTime && $staffSchedTime->title === 'Appointment Time')
                                                                    @php
                                                                        $staffSchedTimeList = json_decode($staffSchedTime->list, true);
                                                                        @endphp
                                                                        @foreach ($staffSchedTimeList as $key => $value)
                                                        ...
                                                        <div class="col-sm">
                                                            <label for="checkup_date" class="form-label">Date <span class="text-danger">*</span></label>
                                                            <input type="date" name="date" id="checkup-date" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                ...
                                <div class="stepgroup col mt-0 mb-4 rounded-bottom" style="height: 735px; overflow-y: auto;">
                                    <div>
                                                                            ...
                                                                            <div>
                                                                                <div class="stepgroup">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <input type="file" class="form-control ps-3 p-2 bg-white text-dark" id="patientImage" name="patientImage" disabled>
                                                                                    </div>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div class="stepgroup">
                                                                                    ...
                                                                                    <div class="mb-3">
                                                                                        ...
                                                                                        <div class="form-check">
                                                                                            <input class="form-check-input" style="color: black; opacity: 100%;" type="radio" name="xray-result" id="normal-xray" value="Normal" {{ optional($medicalRecord)->x_ray === 'Normal' ? 'checked' : '' }} disabled readonly>
                                                                                            <label class="form-check-label ms-2" for="normal-xray" style="color: black; opacity: 100%;">Normal</label>
                                                                                        </div>
                                                                                        <div class="form-check">
                                                                                            <input class="form-check-input" style="color: black; opacity: 100%;" type="radio" name="xray-result" id="with-findings-xray" value="With Findings" {{ optional($medicalRecord)->x_ray !== 'Normal' && optional($medicalRecord)->x_ray ? 'checked' : '' }} disabled readonly>
                                                                                        ...
                                                                                        <div class="form-group ms-5 mt-1" id="additional-info-xray" style="width: 180px;">
                                                                                            <input type="text" class="form-control bg-white text-dark" id="findings-textbox" placeholder="Additional Information" name="findings-textbox" value="{{ optional($medicalRecord)->x_ray ?? '' }}" disabled readonly>
                                                                                        </div>
                                                                                    </div>
                                                    ...
                                                    <div class="card-body table-responsive">
                                                        <div class="datatable-container">
                                                            ...
                                                            <table id="checkupHistory" class="table table-hover" style="width:100%">
                                                                ...
                                                                <tbody>
                                                                    @if ($checkups->count() > 0 || $walkInCheckups->count() > 0)
                                                                    ...
                                                                    <tr>
                                                                        <td>Walk-In</td>
                                                                        <td>
                                                                            <p class="fw-bold mb-1">{{ $walkInCheckup->concern ?? '' }}</p>
                                                                            <p class="text-muted mb-0"> {{ $walkInCheckup->complaint ?? '' }}</p>
                                                                        </td>
                                                                        <td>{{ $walkInCheckup->name ?? '' }}</td>
                                                                        <td>{{ $walkInCheckup->diagnosis ?? '' }}</td>
                                                                        <td>
                                                                            <p class="badge text-bg-info mb-1">{{ $walkInCheckup->prescription ?? '' }}</p>
                                                                        </td>
                                                                        <td>
