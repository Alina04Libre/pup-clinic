    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 mb-4">Create Announcement</h1>
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="written_by" name="written_by" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script>
    ...
    document.getElementById("cancelAnnouncement").addEventListener("click", function() {
        window.location.href = "{{ route('view.announcement') }}";
    });
</script>
@endsection