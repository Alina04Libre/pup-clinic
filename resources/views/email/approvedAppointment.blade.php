                ...
                <table cellpadding="0" cellspacing="0" width="600">
                    ...
                    <tr>
                        <td align="center" bgcolor="#007bff" style="padding: 15px 0;">
                            <h2 style="color: white; text-align: center; font-size: 24px; margin-bottom: 0;">Appointment Confirmed</h2>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 20px;">
                            ...
                            <p>Please make sure to mark your calendar and be ready for your appointment on time.</p>
                            <p>Thank you for choosing the PUP Medical Clinic. We look forward to assisting you!</p>
                        </td>
                    </tr>
                    <tr>
