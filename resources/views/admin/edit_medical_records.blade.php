...
@section('title', 'CREATE MEDICAL RECORDS')


@section('create_medical_records')
<style>
    .stepgroup {
        gap: 5px;
        font-size: .9rem;
                ...
                <div class="row">
                    <div class="userstable">
                        <div class="card mb-4">
                            ...
                            <form method="POST" action="{{ route('medical-record.store', ['patientId' => $patientId]) }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                                        ...
                                                        <div class="stepgroup col">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" name="childhood_illness[]" value="{{ $illness }}" id="{{ strtolower($illness) }}" @if (in_array($illness, old('childhood_illness', $medicalRecord->childhood_illness ?? []))) checked @endif>
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" name="childhood_illness[]" value="Others" id="others" @if (in_array('Others', old('childhood_illness', $medicalRecord->childhood_illness ?? []))) checked @endif>
                                                                            <label class="form-check-label ps-4 ms-2" for="others">Others</label>
                                                                        </div>

                                                                        <div id="illnessothersTextboxContainer" style="{{ in_array('Others', old('childhood_illness', $medicalRecord->childhood_illness ?? [])) ? '' : 'display: none' }}">
                                                                            <label for="illnessothersTextbox">Specify:</label>
                                                                            <input type="text" class="form-control" id="illnessothersTextbox" name="childhood_illness_specify" value="{{ old('childhood_illness_specify', $medicalRecord->childhood_illness_specify ?? '') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="previous_hospitalization" value="yes" id="hospitalizationYes" {{ (old('previous_hospitalization', $medicalRecord->previous_hospitalization) === 'yes') ? 'checked' : '' }}>
                                                                        <label class="form-check-label ps-4 ms-2" for="hospitalizationYes">Yes</label>
                                                                    </div>

                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="previous_hospitalization" value="no" id="hospitalizationNo" {{ (old('previous_hospitalization', $medicalRecord->previous_hospitalization) === 'no') ? 'checked' : '' }}>
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="operation_surgery" value="yes" id="surgeryYes" {{ old('operation_surgery', $medicalRecord->operation_surgery === 'yes') ? 'checked' : '' }}>
                                                                        <label class="form-check-label ps-4 ms-2" for="surgeryYes">Yes</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio" name="operation_surgery" value="no" id="surgeryNo" {{ old('operation_surgery', $medicalRecord->operation_surgery === 'no') ? 'checked' : '' }}>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="medicationsInput" name="medications" value="{{ old('medications') }}">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="allergiesInput" name="allergies" value="{{ old('allergies') }}">
                                                                <div class="invalid-feedback">
                                                                    This field is required.
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div>
                                                        <div class="row">
                                                            ...
                                                            <div class="stepgroup col">
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" name="family-history[]" id="{{ strtolower($familyHistory) }}" value="{{ $familyHistory }}" @if (in_array($familyHistory, old('family-history', $medicalRecord->family_history ?? []))) checked @endif>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" name="family-history[]" id="othersCheckbox" value="Others" @if (in_array('Others', old('family-history', $medicalRecord->family_history ?? []))) checked @endif>
                                                                        <label class="form-check-label ps-4 ms-2" for="othersCheckbox">Others</label>
                                                                    </div>

                                                                    <div id="othersTextboxContainer" style="{{ in_array('Others', old('family-history', $medicalRecord->family_history ?? [])) ? '' : 'display: none' }}">
                                                                        <label for="othersTextbox">Specify:</label>
                                                                        <input type="text" class="form-control" id="othersTextbox" name="others_text" value="{{ old('others_text', $medicalRecord->family_history_specify ?? '') }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="stepgroup col">
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="cigarette-smoking" id="smokingYes" value="Yes" {{ old('cigarette-smoking', $medicalRecord->history_cigarette) === 'Yes' ? 'checked' : '' }}>
                                                                                <label class="form-check-label ms-2" for="smokingYes">Yes</label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="cigarette-smoking" id="smokingNo" value="No" {{ old('cigarette-smoking', $medicalRecord->history_cigarette) === 'No' ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="alcohol-drinking" id="drinkingYes" value="Yes" {{ old('alcohol-drinking', $medicalRecord->history_alcohol) === 'Yes' ? 'checked' : '' }}>
                                                                                <label class="form-check-label ms-2" for="drinkingYes">Yes</label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="alcohol-drinking" id="drinkingNo" value="No" {{ old('alcohol-drinking', $medicalRecord->history_alcohol) === 'No' ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="row mb-2">
                                                                        ...
                                                                        <div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="travelled-abroad" id="abroadYes" value="Yes" {{ old('travelled-abroad', $medicalRecord->history_travel) === 'Yes' ? 'checked' : '' }}>
                                                                                <label class="form-check-label ms-2" for="abroadYes">Yes</label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="radio" name="travelled-abroad" id="abroadNo" value="No" {{ old('travelled-abroad', $medicalRecord->history_travel) === 'No' ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="number" class="form-control" id="bmi" name="bmi" value="{{ $medicalRecord->bmi ?? '' }}" style="width: 180px;" readonly>
                                                                            </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="stepgroup col">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="date" placeholder="1st day of last Menstruation" class="form-control" name="genitoUrinary" value="{{ $medicalRecord->geneto_urinary ?? '' }}">
                                                            </div>
