                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h1 class="text-primary">{{ $doneCheckupAppointments }}</h1>
                                    </div>
                                    <div>
                        ...
                        <div class="card mb-4" style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6>For Check-ups</h6>
                                        <h1 class="text-info">{{ $forCheckupAppointments }}</h1>
                                    </div>
                                    <div>
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="datatable-container">
                                    <table id="appointHistory" class="table table-hover" style="width:100%">
                                        ...
                                        <tbody id="appointHistorytbody">
                                            @foreach($appointments as $appoint)
                                            @if ($appoint->status == 'Done' || $appoint->status == 'Re-Scheduled' || $appoint->status == 'Declined' || $appoint->status == 'Approved' || $appoint->status == 'For Checkup' || $appoint->status == 'Expired')
                                            <tr>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <td></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif ($appoint->status === 'Expired')
                                                            <span class="badge text-bg-secondary">{{ $appoint->status }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            ...
                                                            <!--button class="btn btn-secondary btn-sm export-appointment-btn" data-appointment-id="{{ $appoint->id }}">Export</button-->
                                                        </td>
                                                    </div>
                                                </div>
                                            </tr>
