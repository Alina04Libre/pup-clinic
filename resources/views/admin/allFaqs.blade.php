                    ...
                    <div class="row mt-4 mb-4 d-flex align-items-center ">
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-end align-items-center">
                                <button type="button" onclick="window.location.href='/faqs';" class="btn btn-primary">
                                ...
                                <div class="card-body table-responsive">
                                    @if ($faqs->isEmpty())
                                        <div class="row justify-content-center text-center">
                                            <div class="col-12">
                                                <h3>No Frequently ask question has been made.</h3>
                                                @can('makeFaqs')
                                                    <p>You may create an faq's using the button below.</p>
                                                    <button type="button" onclick="window.location.href='/faqs';"
                                        ...
                                        <div class="datatable-container">
                                            <table id="announcement" class="table table-hover align-middle mb-0 bg-white">
                                                ...
                                                @foreach ($faqs as $faq)
                                                    <tbody>
                                                        <tr>
                                                            <td class="fw-bold mb-1">{{ $faq->question }}</td>
                                                            <td class="fw-normal mb-1">{{ $faq->answer }}
                                                            </td>
                                                            <td>{{ date('F j, Y g:i A', strtotime($faq->created_at)) }}
                                                            </td>
                                                            <td>
                                                                <a href="#" class="btn btn-primary"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#viewFaqModal{{ $faq->id }}">
                                                                ...
                                                                <div class="modal fade" id="viewFaqModal{{ $faq->id }}"
                                                                    tabindex="-1"
                                                                    aria-labelledby="viewFaqModal{{ $faq->id }}"
                                                                    aria-hidden="true">
                                                                ...
                                                                <form method="POST" id="deleteForm"
                                                                    action="{{ route('delete.faqs', ['id' => $faq->id]) }}"
