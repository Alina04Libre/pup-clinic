...
@section('title', 'DOCTOR CHECKUPS')

@section('doctor_all_checkups')
                ...
                <div class="row mt-4 mb-4">
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-end align-items-center"> <!-- Center-align vertically -->
                            <form action="{{ url('/doctor/checkups') }}" method="GET">
                                @csrf
                                        ...
                                        <tbody>
                                            @if(count($walkInCheckups ?? []) > 0)
                                                @foreach($walkInCheckups as $walkInCheckup)
                                                    @if ($walkInCheckup->doctor_id == Auth::user()->id)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <p class="text-muted mb-1">{{ $walkInCheckup->nurse->name ?? '' }} {{ $walkInCheckup->nurse->last_name ?? '' }}</p>
                                                            </td>
                                                            <td>
