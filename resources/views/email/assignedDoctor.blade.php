                ...
                <table cellpadding="0" cellspacing="0" width="600">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 20px;">
                            <p><strong>Dear Dr. {{ $appointment->doctor->name }},</strong></p>
                            <p>You have been assigned to see a patient for an appointment. Here are the details:</p>
                            <ul>
                            ...
                            <p>Please make sure to review the patient's information and be prepared for the appointment at the scheduled time.</p>
                            <p>Thank you for your dedication and service at the PUP Medical Clinic. Your expertise is greatly appreciated!</p>
                        </td>
                    </tr>
                    <tr>
