...
<body style="font-family: Arial, Helvetica, sans-serif; padding-top: 0px; margin-top: 0px;">
    ...
    <div style="font-family: Arial, Helvetica, sans-serif;">
        <p>
            ...
            <table>
                <tr>
                    <th style="border: none; padding: 0px;">Sex: <span></span></th>
                    <td style="border: none; padding: 0px;">Civil Status: <span></span><br></td>
                    <td style="border: none; padding: 0px;">Blood Type: <span></span></td>
                    <td style="border: none; padding: 0px;">PWD: <span></span></td>
                </tr>
            </table>
            ...
            Contact Person In Case of Emergeny: <span></span><br>
            Contact Number: <span></span><br>
        </p>
